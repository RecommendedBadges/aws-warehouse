...
const AUTH_JWT_GRANT_COMMAND = 'npm-exec sf org login jwt';
const LIMITS_API_DISPLAY_COMMAND = 'npm-exec sf limits api display';
const PACKAGE_INSTALL_COMMAND = 'npm-exec sf package install';
const PACKAGE_VERSION_CREATE_COMMAND = 'npm-exec sf package version create';
const PACKAGE_VERSION_CREATE_REPORT_COMMAND = 'npm-exec sf package version create report';
const PACKAGE_VERSION_PROMOTE_COMMAND = 'npm-exec sf package version promote';
const SOQL_QUERY_COMMAND = 'npm-exec sf data query';
